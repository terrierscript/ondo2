...
var DegreeStorage = (function () {
  function DegreeStorage() {
    _classCallCheck(this, DegreeStorage);

    this.url = 'https://torid-fire-7950.firebaseio.com/';
    this.degrees = new _firebase2['default'](this.url + 'degree_log');
  }

  _createClass(DegreeStorage, [{
    key: 'degreePromise',
    value: function degreePromise() {
      var _this = this;

      var limit = arguments.length <= 0 || arguments[0] === undefined ? 60 : arguments[0];

      return new Promise(function (resolve, reject) {
        var logs = [];
        _this.degrees.limitToLast(limit).on('value', function (snapshot) {
...
var LogItem = (function (_React$Component2) {
  ...
  function LogItem() {
    ...
    _get(Object.getPrototypeOf(LogItem.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(LogItem, [{
    ...
    key: 'render',
    value: function render() {
      var _props$log = this.props.log;
      var time = _props$log.time;
      var degree = _props$log.degree;
...
var App = (function (_React$Component4) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      degreeStorage.degreePromise().then(function (logs) {
        _this2.setState({
          logs: logs
        });
      });
    ...
    value: function render() {
      ...
      var logItems = logs.map(function (log) {
        return _react2['default'].createElement(LogItem, { key: log.key, log: log.val });
      });
      return _react2['default'].createElement(
        'div',
        null,
        logItems.length === 0 ? _react2['default'].createElement(Loading, null) : { logItems: logItems }
      );
    }
  }]);
...
},{"classname":2,"firebase":3,"react":158}],160:[function(require,module,exports){
'use strict';
...
_react2['default'].render(_react2['default'].createElement(_AppJsx2['default'], null), container);

},{"./App.jsx":159,"react":158}]},{},[160]);
